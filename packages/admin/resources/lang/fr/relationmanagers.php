...
return [
    'customer_groups' => [
        ...
        'actions' => [
            ...
            'edit' => [
                'modal' => [
                    'heading' => 'Modifier le groupe de clients',
                ],
            ],
        ],
        'form' => [
    ...
    'medias' => [
        ...
        'form' => [
            'name' => [
                'label' => 'Nom',
                'helper_text' => 'Utilisé comme texte alternatif de l\'image — important pour le SEO et l\'accessibilité des personnes malvoyantes.',
            ],
            'media' => [
                'label' => 'Image',
            ],
