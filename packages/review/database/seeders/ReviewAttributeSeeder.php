...
namespace Lunar\Review\Database\Seeders;
...
class ReviewAttributeSeeder extends AbstractSeeder
{
    /**
    ...
    {
        $groups = $this->getSeedData('reviewAttributes');

        DB::transaction(function () use ($groups) {
            $this->createAttributeGroupsWithAttributes($groups);
        });
    }

    /**
     * Create attribute groups with attributes for reviews.
     */
